...
import 'package:vsTest/Student/Sbox/Sbox2/Sbox2.dart';
import 'package:vsTest/Student/Sbox/Sbox3/Sbox3.dart';
import 'package:vsTest/Student/Sbox/Sbox4/Sbox4.dart';
import 'package:vsTest/Student/Sbox/Sbox5/Sbox5.dart';
import 'package:vsTest/api_constants.dart';
...
class _HomePageState extends State<HomeStudent> {
    ...
    try {
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('บันทึกการเข้าเรียนสำเร็จ')),
        );
      } else {
        print('Failed to send attendance data');
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('เกิดข้อผิดพลาดในการบันทึกการเข้าเรียน')),
        );
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildFunctionBox(
                    ...
                    () => Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const Box3())),
                  ...
                  buildFunctionBox(
                    ...
                    () => Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const Box4())),
                  ...
                  buildFunctionBox(
                    ...
                    () => Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const Box5())),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // เพิ่มฟังก์ชันทดสอบการส่งข้อมูลที่นี่
          sendAttendanceData(1234, 5678); // ใช้ค่าทดสอบ
        },
        tooltip: 'ทดสอบส่งข้อมูล',
