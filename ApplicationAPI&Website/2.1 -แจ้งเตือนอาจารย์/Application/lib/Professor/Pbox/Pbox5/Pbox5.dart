...
import 'package:ClassTracking/Function/f2p.dart';
import 'package:ClassTracking/Function/f3.dart';
import 'package:ClassTracking/Professor/Pbox/Pbox5/ProfileP.dart';
import 'package:ClassTracking/login.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class Pbox5 extends StatefulWidget {
...
class _SBox4State extends State<Pbox5> {
  ...
  void _navigateToPack1() async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ProfileP(idNumber: widget.idNumber),
      ),
    );
    if (result != null) {
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => f1(isProfessor: false)),
                );
              },
              child: const OptionBox(
                image: 'assets/Images/pack2.png',
                title: 'สิทธิ์และการเชื่อมต่อ',
                subtitle: 'การเข้าถึงข้อมูลและการเชื่อมต่อ',
              ),
            ),
          ),
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => f2p()),
                );
              },
              child: const OptionBox(
